...
export const pricingGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sweetheart-table-setup", name: "Sweetheart Table Setup", price: "$350", amount: 350, unit: null, image: "/items/tables/sweetheart_table_cropped.jpg" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "display-shelf", name: "Shelf", price: "$150", amount: 150, unit: null, image: "/items/decor-displays/shelfie.jpg" },
      {
        id: "custom-panels",
      ...
      { id: "center-stand", name: "Center Stand", price: "$1,500", amount: 1500, unit: null, image: "/items/decor-displays/center_stand.jpg" },
      { id: "lei-stand", name: "Lei Stand", price: "$350", amount: 350, unit: null, image: "/gallery/stand_set_up.jpg" },
      { id: "white-pedestal-34", name: 'White Pedestal (34")', price: "$50 each", amount: 50, unit: "each", image: "/items/decor-displays/pedestals_sizes.jpg" },
      { id: "white-pedestal-24", name: 'White Pedestal (24")', price: "$50 each", amount: 50, unit: "each", image: "/items/decor-displays/pedestals_sizes.jpg" },
      { id: "white-pedestal-22", name: 'White Pedestal (22")', price: "$50 each", amount: 50, unit: "each", image: "/items/decor-displays/pedestals_sizes.jpg" },
